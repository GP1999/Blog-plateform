...
import {getBlog,getListOfBlogs,createBlog,updateBlog,deleteBlog,getNumberOfBlogs} from './blogs.service'
...
blogsRouterV1.get('/blogCount/:writerId',getNumberOfBlogs)
const router = Router();
